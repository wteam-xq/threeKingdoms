...
### 留存bug
* PC端 进入卡牌二级页面 二维码按钮出现且无法点击（不应该出现）
* 小米系统(最新MIUI)浏览器 武将菜单 下拉首次增加数据时， 加载图标右侧渲染出脏节点； 
* 在某个详情页面点击 搜索栏， 然后以 详情页关键字搜索， 点击搜索列表 再次进入该详情页， 结果只能 在该详情页 与 搜索列表页 无法返回主菜单。
  * 例如 “虎牢关规则”详情页， 点击搜索栏， 进入搜索页后搜索“关”，点击列表中的“虎牢关规则”， 进入“虎牢关规则”详情页；之后无法返回主菜单。 